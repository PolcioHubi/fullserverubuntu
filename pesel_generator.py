...
def generate_pesel(birth_date, gender):
    ...
    # — pierwszeństwo nad ogólnym komunikatem ValueError z datetime, żeby
    # konsumenci dostawali stabilny tekst błędu właściwy dla algorytmu PESEL.
    if day == 29 and month == 2 and year == 1900:
        raise ValueError(
            "Błąd w generowaniu PESEL: 29 lutego 1900 nie jest prawidłową datą dla PESEL."
        )

    # Pozostałe walidacje daty oparte o standardowy moduł datetime.
    try:
